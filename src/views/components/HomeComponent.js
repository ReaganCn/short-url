  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={props.showAccountSettings ? {visibility:"visible"} : {visibility:"collapse"}}
      >
        <div
        ...
        >
          ...
          <div id="details" className="flex flex-col justify-between">
            <div className="flex justify-between flex-row my-4 mx-6">
              ...
              <button className="text-sm md:text-base border w-3/12 md:w-2/12 hover:text-white p-1 rounded hover:border-transparent ml-5 hover:bg-darkviolet bg-white border-darkviolet text-darkviolet">
                Update
              </button>
            </div>
            <div className="flex justify-between flex-row my-4 mx-6">
          ...
          <button className="text-sm md:text-base border w-3/12 md:w-2/12 text-white p-1 rounded border-transparent ml-auto bg-darkviolet hover:bg-white hover:border-darkviolet hover:text-darkviolet mr-6"
