...
const ShortComponent = (props) => {
  return (
    <div className="w-9/12 flex flex-col mt-16 border rounded p-12 mx-auto">
      <div className="">
        <form className=" flex flex-row self-start h-10 justify-between" onSubmit={props.onSubmit}>
          <input
            type="text"
            name="url"
            id="original url"
        ...
        <div className="flex-row self-start">
          ...
          <div className="flex flex-col md:flex-row justify-between border mb-1 border-purple-200 rounded pl-2 md:p-0 mt-3">
            <p className="md:self-center md:ml-2">www.google.com</p>
            <a className="md:self-center font-semibold text-blue-600" href={`link0.ga/${props.input.shorturl}`} target="_blank">link0.ga/{props.input.shorturl}</a>
            <div>
